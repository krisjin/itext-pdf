...
public class ChineseFontProvider extends XMLWorkerFontProvider {
	// String
	// ft="new Font(BaseFont.createFont("STSong-Light", "UniGB-UCS2-H", BaseFont.EMBEDDED),18)";
	...
	public ChineseFontProvider(String dontlookforfonts) {
		super(dontlookforfonts);
